...
class ConfigTests(unittest.TestCase):
    ...
    def test_example_configs_validate(self) -> None:
        ...
        self.assertFalse(cfg.hardware.encoder_enabled)
        self.assertEqual(cfg.hardware.encoder_type, "adafruit_seesaw")
        self.assertEqual(cfg.hardware.encoder_address, 0x36)
        self.assertEqual(cfg.hardware.left_button.short_action, "prev")
        self.assertEqual(cfg.hardware.right_button.long_action, "select")
