...
class DisplayEventType(str, Enum):
    # Hardware Rev D primary encoder events.
    ENCODER_CW = "ENCODER_CW"
    ENCODER_CCW = "ENCODER_CCW"
    ENCODER_PRESS = "ENCODER_PRESS"
    ENCODER_LONG_PRESS = "ENCODER_LONG_PRESS"
    ENCODER_DISCONNECTED = "ENCODER_DISCONNECTED"
    ENCODER_RECONNECTED = "ENCODER_RECONNECTED"
    # Checkpoint 5 aliases (same intents as CW/CCW).
